 ...
 *  This demonstrates using batch rendering to render a lot of static geometry as
 * 	well as to optimize the animation code.
 * 
 * 	So you will note a lot of code changes.
 *  
 */
