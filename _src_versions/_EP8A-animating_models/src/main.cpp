 ...
 * @date: 30-12-2024
 * 
 *  Episode 8: "openGL with C++ 8: Animating Models"
 *  This _EP8A is the program following Episode 7; it shows the updated version, updated
 * 	in preparation for Episode 8.
 *  
 */
