...
RenderSystem::RenderSystem(unsigned int shader, GLFWwindow* window) {
    ...
    m_Textures[objectType] = meshFactory.make_texture("../_resources/img/spider_3d_image1a.jpg");
    ...
    m_VBOs[objectType][animationType].push_back(mesh.VBO);
    m_VertexCounts[objectType] = mesh.vertexCount;
    m_Textures[objectType] = meshFactory.make_texture("../_resources/img/stargirl.png");
    ...
    m_Textures[objectType] = meshFactory.make_texture("../_resources/img/Revy_Final.png");
