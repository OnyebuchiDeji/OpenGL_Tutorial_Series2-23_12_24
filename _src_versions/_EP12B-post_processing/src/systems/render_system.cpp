...
RenderSystem::RenderSystem(std::vector<unsigned int>& shaders, GLFWwindow* window,
    ...
    m_Animations(animations), m_FrameBuffer(framebuffer)
{
...
void RenderSystem::update() {
    //  Change rendering target to current frame buffer
    ...
    //  No swapping here because screen is not to be updated yet.
