 ...
 * @date 2024-12-24
 * 
 * Episode 3: "OpenGL with C++ 4: Vertex Buffers"
 * 
 */
...
int main()
{
     ...
     *   std::ifstream file;
     *   std::string line;
     *   // file.open("C:/My_Practice_Projects/C++_Projects/Graphics_Projects/OpenGL_Tutorial_Series2-23_12_24/core/src/shaders/vertex.txt");
     *   //  This works. Consider it looking from the `build` folder.
     *   file.open("../core/src/shaders/vertex.txt");
