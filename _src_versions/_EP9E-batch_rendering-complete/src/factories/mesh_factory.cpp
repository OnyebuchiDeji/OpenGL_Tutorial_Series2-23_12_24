...
void MeshFactory::append_cube_mesh(glm::vec3 size, float layer)
{
    ...
    //  No more: x, y, z, u, v, r, g, b
    //  Now: x, y, z, u, v, layer, r, g, b
    m_Vertices = {
...
StaticMesh MeshFactory::build_obj_mesh()
{
    ...
    /**
     * 
     *  The division is because there are 8 vertices or vertex data per point...
     *  vertexCount is the count for number of points that make up a triangle
     *  The division changed from 8 to 9 because each vertex has 9 values now, becaus of the added 'layer'
     *  data.
     */
    mesh.vertexCount = m_Vertices.size() / 9;
    mesh.VBO = VBO;
