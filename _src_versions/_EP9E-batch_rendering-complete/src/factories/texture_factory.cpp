...
void TextureFactory::start_texture_array(int layers)
{
    ...
    /**
     *  reserves space for a certain texture object
     *  arg1: type of texture object
     *  arg2: level
     *  arg3: internal format
     *  arg4: width; arg5: height
     *  arg6: no. of layers
     * 
     */
    //  Note that the author, Andrew, had already resized the textures to 1024x1024
    //  Also, all the textures must be the same dimension
    ...
    // glTexStorage3D()
    // std::cout << "Done!\n";
    // std::cout << "Texture Layers: " << layers << "\n";
}
