...
void RenderSystem::build_geometry()
{
    ...
    meshFactory.append_obj_mesh("../_resources/models/ground.obj", preTransform);
    //  West wall
    preTransform = glm::mat4(1.0f);
    preTransform = glm::translate(preTransform, {10.0f, 0.0f, 0.0f});
    meshFactory.append_obj_mesh("../_resources/models/wall.obj", preTransform);
    //  East wall
    preTransform = glm::mat4(1.0f);
    preTransform = glm::translate(preTransform, {-10.0f, 0.0f, 0.0f});
    meshFactory.append_obj_mesh("../_resources/models/wall.obj", preTransform);
    ...
    meshFactory.append_obj_mesh("../_resources/models/corner.obj", preTransform);
    //  Southwest Corner
    preTransform = glm::mat4(1.0f);
    preTransform = glm::translate(preTransform, {10.0f, -10.0f, 0.0f});
    meshFactory.append_obj_mesh("../_resources/models/corner.obj", preTransform);
    ...
    meshFactory.append_obj_mesh("../_resources/models/tree.obj", preTransform);
    //  Another Tree
    preTransform = glm::mat4(1.0f);
    ...
    m_VertexCounts[objectType] = mesh.vertexCount;
    m_Textures[objectType] = textureFactory.make_texture("../_resources/img/paper.jpg");
...
void RenderSystem::update(
    ...
    glBindTexture(GL_TEXTURE_2D, m_Textures[ObjectType::eGeometry]);
