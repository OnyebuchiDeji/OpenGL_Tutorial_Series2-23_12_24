 ...
 *          
 *  In this _EP5C, the View Matrix is created.
 *  It's created with this coolade Matrix derived from the Camera's vectors.
 */
#include "config.h"
...
int main()
{
     ...
     */
    lm::vec3 quad_position = {-0.2f, 0.4f, 0.0f};
    ...
    lm::vec3 camera_target = {0.0f, 0.0f, 0.0f};
    ...
    lm::mat4 view = lm::create_look_at(camera_pos, camera_target);
